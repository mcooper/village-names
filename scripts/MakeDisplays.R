...
map(database='world', regions=c('Senegal','Guinea-Bissau', 'Sierra Leone', 'Liberia', 'Guinea','Ivory Coast','Mauritania','Burkina Faso','Mali','Gambia','Ghana','Benin','Togo'), xlim=c(-17.5, 2.5), ylim=c(4, 20), main='Place names containing the 3-gram "ama"')
points(sel$longitude, sel$latitude, cex=0.25, pch=19, col=2)
main('Place names containing the 3-gram "ama"')
